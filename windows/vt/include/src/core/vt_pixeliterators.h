...
// 
// Synposis: initializer for specifying a region and step size in the
//           CBlockIterator
//
//------------------------------------------------------------------------------
struct BLOCKITER_INIT
...
// Class: CBlockIndex
// 
// Synposis: a class to lookup blocks via index
//
//------------------------------------------------------------------------------
class CBlockIndex
{
...
// Class: CSpanIterator
// 
// Synposis: simple class to step in size of stepsize across a span with the
//           given width
//
//------------------------------------------------------------------------------
class CSpanIterator
...
public:
    CSpanIterator(int width, int stepsize) : 
        m_iWidth(width), m_iCurPos(0), m_iStepSize(stepsize)
