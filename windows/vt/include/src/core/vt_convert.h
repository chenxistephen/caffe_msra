...
#if defined(MAKE_DOXYGEN_WORK) || (defined(VT_WINRT) && !(WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP)) // WBM not available for WP8
/// \ingroup conversion
...
// 
// Synposis: IImageTransform implementation of convert
// 
//------------------------------------------------------------------------------
