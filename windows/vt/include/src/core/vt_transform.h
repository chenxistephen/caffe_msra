...
// 
// Synposis: Implementation of ITransformBlockMap. Traverses the destination
...
// 
// Synposis: returned from image transforms to describe which inputs and the 
...
// 
// Synposis: returned from GetReaderSource method on CTransformGraphNode
...
// 
// Synposis: contains the writer and optional block map for a transform
//           graph node
// 
//------------------------------------------------------------------------------
struct NODE_DEST_PARAMS
...
// 
// Synposis: A node in a transform graph.  This allows transforms to be chained
...
// 
// Synposis: a CTransformGraphNode with no source reader input
// 
//------------------------------------------------------------------------------
...
// 
// Synposis: a CTransformGraphNode with a single input
// 
//------------------------------------------------------------------------------
...
// 
// Synposis: a CTransformGraphNode with multiple inputs
// 
//------------------------------------------------------------------------------
...
// 
// Synposis: Executes the specified transform graph. Will potnetially issue the
...
// 
// Synposis: a unary image transform that needs as input only the exactly
...
// 
// Synposis: a multi-source image transform that requires only exactly the 
...
// 
// Synposis: a Geo(metric) image transform that has a single input
// 
//------------------------------------------------------------------------------
template <class Derived, bool bRequiresCloneForConcurrency>
