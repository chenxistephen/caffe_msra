...
// Class: CLogHistogram
// 
// Synposis: a class to bin a range of values in a log space
// 
//------------------------------------------------------------------------------
class CLogHistogram
{
public:
	...
	~CLogHistogram() 
	{ delete m_pHistogram; delete m_pMantissaLogs; }
...
protected:
	...
	{ 
	    return ldexp(float((1<<m_uMantissaBits) + uMant), 
...
// Lu
// Synposis: a wrapper class that sepecifies the width of the counts
// 
//------------------------------------------------------------------------------
template <class T>
...
// 
// Synposis: a wrapper class that allows interpolated counts
// 
//------------------------------------------------------------------------------
...
public:
	void Acc(UInt32 packed, float count = 1.f)
	{
        ...
        // find fraction * count
        float fract1 = (float) (packed & mask) * inv_mask;
        fract1 *= count;
        float fract0 = count - fract1;
...
// 
// Synposis: inline functions that return mantissa and exponent for various types
// 
//------------------------------------------------------------------------------
...
// 
// Synposis: a helper that packs a value into the log index representation of
//           CLogHistogram
// 
//------------------------------------------------------------------------------
template <class T>
...
// 
// Synposis: a helper function that converts an bin from one histogram 
//           into another
// 
//------------------------------------------------------------------------------
UInt32
...
// Function: 
// 
// Synposis: functions to compute histograms
// 
//------------------------------------------------------------------------------
template <class T>
...
// 
// Synposis: a helper function that smooths a histogram using a 12421 filter
// 
//------------------------------------------------------------------------------
