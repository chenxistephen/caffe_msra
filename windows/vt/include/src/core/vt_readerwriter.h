...
//
// Synposis: function that returns the total number of pixels in an 
...
// Class: IImageReader
//
// Synposis: interface for getting image information and portions of images
//
//------------------------------------------------------------------------------
class IImageReader
{
...
// Class: IImageWriter
// 
// Synposis: interface for writing an image or portion of an image
//
//------------------------------------------------------------------------------
class IImageWriter
{
...
// 
// Synposis: combined reader/writer interface
//
//------------------------------------------------------------------------------
...
//
// Synposis: an implementation of IImageReaderWriter that simply wraps a 
...
public:
	...
	virtual HRESULT ReadImg(OUT CImg& dst, UINT uLevel=0)
	{ return ReadRegion(Rect(), dst, uLevel); }
	...
	{ return ( uLevel==0 )? WriteRegion(Rect(), src): E_INVALIDARG; }
...
//
// Synposis: an implementation of IImageReader that wraps a pyramid
// 
//------------------------------------------------------------------------------
template <class Pyr> 
...
// 
// Synposis: a reader that can index into multiple frames
//
//------------------------------------------------------------------------------
class IIndexedImageReader
{
public:
	virtual ~IIndexedImageReader() = 0
	{} 
...
// 
// Synposis: a writer that can index into multiple frames
//
//------------------------------------------------------------------------------
class IIndexedImageWriter
{
public:
	virtual ~IIndexedImageWriter() = 0
	{}
...
// 
// Synposis: helper function for implementors of IndexedImage iterators that
...
// 
// Synposis: an iterator class to step through indexed readers
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an IIndexedImageReader that wraps a collection of images
//
//------------------------------------------------------------------------------
template <class T>
...
// 
// Synposis: an iterator class to step through indexed writers
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an iterator class to step through indexed reader/writer
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an image reader presents the sub-level of a contained image as 
//           level 0
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an indexed image reader presents the sub-level of a contained 
//           image as level 0
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an image writer that presents the sub-level of a contained image as 
//           level 0
//
//------------------------------------------------------------------------------
...
// 
// Synposis: an indexed image reader that crops a provided indexed image reader
//
//------------------------------------------------------------------------------
...
//
// Synposis: class that remaps a set of sources into levels of the presented
//           IImageReaderWriter
// 
//------------------------------------------------------------------------------
...
//
// Synposis: class that remaps a set of source readers into a new IIndexedImageReader
// 
//------------------------------------------------------------------------------
...
//
// Synposis: helper class that handles the commonly occuring pattern of
...
{
public:
	CIndexedPrefetchHelper(UINT uDepth) : m_uDepth(uDepth), m_uPrefetchIndex(0)
	{}
