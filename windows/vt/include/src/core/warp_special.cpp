...
// from pad.cpp
extern HRESULT ConvertConstval(EXTEND_CONSTVAL& excDst, const CImgInfo& imgDst,
    ...
    )
{
    ...
    {
        VT_HR_EXIT( ConvertConstval(ex.excHoriz, imgDstBlk.GetImgInfo(), exParam.excHoriz) );
    }
