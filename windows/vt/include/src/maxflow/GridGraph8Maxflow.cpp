...
#define INST_PARENT_EDGES(N, T) \
    const unsigned GridGraph8<N, T>::PARENT_TERMINAL = (unsigned)GridGraph8<N, T>::NeighborhoodSize;\
    const unsigned GridGraph8<N, T>::PARENT_ORPHAN   = (unsigned)GridGraph8<N, T>::NeighborhoodSize+1;\
    const unsigned GridGraph8<N, T>::PARENT_FREE     = (unsigned)GridGraph8<N, T>::NeighborhoodSize+2;
...
// /*static*/ const unsigned GridGraph8::PARENT_TERMINAL = GridGraph8::NeighborhoodSize;
// /*static*/ const unsigned GridGraph8::PARENT_ORPHAN   = GridGraph8::NeighborhoodSize+1;
// /*static*/ const unsigned GridGraph8::PARENT_FREE     = GridGraph8::NeighborhoodSize+2;
...
template <class NLinkFlowType,class TotalFlowType> 
  void GridGraph8<NLinkFlowType,TotalFlowType>::ActiveQueueReset()
{
...
template <class NLinkFlowType,class TotalFlowType> 
  void GridGraph8<NLinkFlowType,TotalFlowType>::ActiveQueueAdd(NodeId p)
{
...
template <class NLinkFlowType,class TotalFlowType> 
  inline typename GridGraph8<NLinkFlowType,TotalFlowType>::NodeId GridGraph8<NLinkFlowType,TotalFlowType>::ActiveQueueGetTop()
{
...
template <class NLinkFlowType,class TotalFlowType> 
  void GridGraph8<NLinkFlowType,TotalFlowType>::ActiveQueueRemoveTop()
{
...
template <class NLinkFlowType,class TotalFlowType> 
  GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::NodeQueue()
    : m_start(NULL)
{
}
...
template <class NLinkFlowType,class TotalFlowType> 
  HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::Allocate(int size)
{
    ASSERT(size > 0);
...
template <class NLinkFlowType,class TotalFlowType> 
  void GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::DeAllocate()
{
    if (m_start)
    {
        delete [] m_start;
...
template <class NLinkFlowType,class TotalFlowType> 
  inline void GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::Reset()
{
    ASSERT(m_start != NULL);
...
template <class NLinkFlowType,class TotalFlowType> 
  inline HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::EnQueue(NodeId p)
{
    ASSERT(m_start != NULL);
...
template <class NLinkFlowType,class TotalFlowType> 
  inline typename GridGraph8<NLinkFlowType,TotalFlowType>::NodeId GridGraph8<NLinkFlowType,TotalFlowType>::NodeQueue::DeQueue()
{
    ASSERT(m_start != NULL);
...
template <class NLinkFlowType,class TotalFlowType> 
  GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::NodeStack()
    : m_start(NULL)
{
}
...
template <class NLinkFlowType,class TotalFlowType> 
  HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::Allocate(int size)
{
    ASSERT(size > 0);
...
template <class NLinkFlowType,class TotalFlowType> 
  void GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::DeAllocate()
{
    if (m_start)
    {
        delete [] m_start;
...
template <class NLinkFlowType,class TotalFlowType> 
  inline void GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::Reset()
{
    ASSERT(m_start != NULL);
    m_current = m_start;
}
...
template <class NLinkFlowType,class TotalFlowType> 
  inline HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::Push(NodeId p)
{
    ASSERT(m_start != NULL);
...
template <class NLinkFlowType,class TotalFlowType> 
  inline typename GridGraph8<NLinkFlowType,TotalFlowType>::NodeId GridGraph8<NLinkFlowType,TotalFlowType>::NodeStack::Pop()
{
    ASSERT(m_start != NULL);
...
template <class NLinkFlowType,class TotalFlowType> 
  bool GridGraph8<NLinkFlowType,TotalFlowType>::Grow(NodeId& source_node, NodeId& sink_node, int& source_edge)
{
    NodeId p;
    NodeId q;
    int e;
...
template <class NLinkFlowType,class TotalFlowType> 
  HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::Augment(NodeId source_node, NodeId sink_node, int boundaryEdge)
{
    HRESULT hr;
    NodeId p;
    int e;
...
template <class NLinkFlowType,class TotalFlowType> 
  HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::Adopt(NodeId p)
{
    HRESULT hr;
    NodeId q;
    NodeId r;
...
template <class NLinkFlowType,class TotalFlowType> 
  HRESULT GridGraph8<NLinkFlowType,TotalFlowType>::Maxflow(int flag)
{
    HRESULT hr;
    NodeId p;
