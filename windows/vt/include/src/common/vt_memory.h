...
void *VtMemset(void *pDest, int c, size_t count, bool bBypassCache=false);

void *VtMemcpy(void *pDest, const void *pSrc, size_t count, 
			   bool bBypassCache=false);

void *VtFillSpan(void *pDest, const void *pSrcEl, size_t uiElSize, int iCount,
				 bool bBypassCache=false);
...
inline bool IsAligned16(const void *p) { return (((INT_PTR)(p))&15)==0; }
