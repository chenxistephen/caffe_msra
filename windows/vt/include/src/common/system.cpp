...
DWORD vt::CSystem::GetTempPath(DWORD nBufferLength, LPWSTR lpBuffer)
{
#if defined(VT_WINRT)
	if (lpBuffer == NULL)
	{
...
UINT vt::CSystem::GetTempFileName(LPCWSTR lpPathName, LPCWSTR lpPrefixString, UINT uUnique, LPWSTR lpTempFileName)
{
#if defined(VT_WINRT)
...
BOOL vt::CSystem::SwitchToThread()
{
#if defined(VT_WINRT)
