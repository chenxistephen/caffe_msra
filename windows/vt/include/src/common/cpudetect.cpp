...
//     on this issue.
/***********************************************************************/
#if defined(_M_AMD64) && !defined(VT_GCC)
...
#if defined(_M_IX86) && !defined(VT_GCC)
...
#elif defined (_M_AMD64) && !defined(VT_GCC)
...
#else
#pragma message(__WARNING__ "Missing implementation for this target platform")
#endif
...
{
#if (defined(_M_IX86)||defined(_M_AMD64)) && !defined(VT_GCC) && !defined(MSRVT_WINDOWS_BUILD)
    if (!g_iCPUDetected)
		prvDetectCPUPtr();
